...
const WithCancelled = () => {
  ...
  const tableData = [
    ...
    2.0,
    18.0,
    "Trc20 Usdt Address : hljljhjghjjjjk",
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold mb-[10px]">Cancelled Withdrwals</h2>
      <PagePath
        pathOne={"/"}
        pathTwo={"#"}
        pathOneName={"Home"}
        pathTwoName={" Withdrwals"}
        pathThreeName={" Cancelled"}
      />

      <h2 className="text-sm font-semibold mt-[25px]">CANCELLED WITHDRWALS</h2>
